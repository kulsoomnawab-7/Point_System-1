			...
			<div class="container">
                <div class="row">
                    ...
                    <?php
                      ...
                      ->join('faculties','faculties.id','batches.current_faculty')
                    ...
                    <div class="col-md-6">
                       ...
                       <input value="{{$student_data->faculty}}/{{$student_data->Batch}}" type="text" class="pl-5" style=" border-bottom: 2px solid rgb(0, 0, 0); border-top: none; border-right: none; border-left: none; width:16rem;" required>
                       <input value="{{$student_data->faculty}}" type="hidden" class="pl-5"name="faculty" style=" border-bottom: 2px solid rgb(0, 0, 0); border-top: none; border-right: none; border-left: none; width:16rem;">
                                            ...
                                            <p class="control">
                                                ...
                                                <p class="control">
                                                  ...
                                                  <label class="checkbox">
                                                    ...
                                                    <input type="text" name="technical_r" id="customs" disabled style=" border-bottom: 2px solid rgb(0, 0, 0); border-top: none; border-right: none; border-left: none; width:25rem;">
                                                  </label>
                                                </p>
                                                <!-- <p class="control">
                                                  <label class="checkbox">
                                            ...
                                            <p class="control">
                                                ...
                                                <p class="control">
                                                  ...
                                                  <label class="checkbox">
                                                    ...
                                                    <input type="text" name="clearing_r" id="custom1" disabled style=" border-bottom: 2px solid rgb(0, 0, 0); border-top: none; border-right: none; border-left: none; width:25rem;">
                                                  </label>
                                                </p>
                                                <!-- <p class="control">
                                                  <label class="checkbox">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6"  style="border:1px solid black;">
                                            ...
                                            <p class="control">
                                                  ...
                                                  <input onclick="document.getElementById('custom3').disabled = true; document.getElementById('charstype').disabled = false;" type="radio" value="4" name="book" required> Excellent
                                          
                                                  </label>
                                                </p>
                                                   <p class="control">
                                                  <label class="checkbox">
                                                    <input onclick="document.getElementById('custom3').disabled = true; document.getElementById('charstype').disabled = false;" type="radio" value="3" name="book" required> Good                                                  
                                                  </label>
                                                </p>
                                                ...
                                                <p class="control">
                                                  ...
                                                  <input onclick="document.getElementById('custom3').disabled = true; document.getElementById('charstype').disabled = false;" type="radio" value="2" name="book" required> Average                                                  
                                                </label>
                                                </p>
                                                   <p class="control">
                                                  <label class="checkbox">
                                                    <input onclick="document.getElementById('custom3').disabled = false; document.getElementById('charstype').disabled = true;" type="radio"  name="book" value="1" required> Fair
                                                    <input type="text" name="book_r" id="custom3" disabled style=" border-bottom: 2px solid rgb(0, 0, 0); border-top: none; border-right: none; border-left: none; width:25rem;">
                                                  </label>
                                                </p>
                                                <!-- <p class="control">
                                                  <label class="checkbox">
                                        ...
                                        <div class="col-md-6"  style="border:1px solid black;">
                                            ...
                                            <p class="control">
                                                  ...
                                                  <input onclick="document.getElementById('custom4').disabled = true; document.getElementById('charstype').disabled = false;" type="radio" value="4" name="student" required> Yes                                                  
                                                   ...
                                                   <p class="control">
                                                  <label class="checkbox">
                                                    <input onclick="document.getElementById('custom4').disabled = false; document.getElementById('charstype').disabled = true;" type="radio"  name="student" value="1" required> No, specify the topics missed:
                                            ...
                                            <p class="control">
                                                ...
                                                <p class="control">
                                                  ...
                                                  <label class="checkbox">
                                                    ...
                                                    <input type="text" name="computer_r" id="custom5" disabled style=" border-bottom: 2px solid rgb(0, 0, 0); border-top: none; border-right: none; border-left: none; width:25rem;">
                                                  </label>
                                                </p>
                                                  <!-- <p class="control">
                                                    <label class="checkbox">
